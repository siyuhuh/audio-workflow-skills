...
The suite marketing version for this beta is `0.8.0`; the prerelease tag and Electron semver are `0.8.0-beta.2`.

## Desktop release

```bash
git tag -a v0.8.0-beta.2 -m "VocalFlow 0.8.0 beta 2"
git push siyuhuh v0.8.0-beta.2
```
