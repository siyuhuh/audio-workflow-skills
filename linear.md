...
Reference DESIGN.md for dark-neutral SaaS with one surgical green accent.
...
--accent:          #37d67a   /* dashboard green, use sparingly */
--accent-hover:    #2fc86f
```

Rule: accent only on primary action, selected navigation, link underlines, and focus rings. Never on full-page backgrounds.
...
Bias: high information density, Inter everywhere, one green accent, 1px borders, 8px radius max, keyboard-first UX.
